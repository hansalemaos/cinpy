...
# %timeit cinpy.aa_cpp_radixsort_int(a)
# %timeit np.sort(a)
# 20.8 ms ± 392 µs per loop (mean ± std. dev. of 7 runs, 10 loops each)
# 167 ms ± 693 µs per loop (mean ± std. dev. of 7 runs, 10 loops each)
import importlib
import cinpy


modulename = "cppsort_radix"
